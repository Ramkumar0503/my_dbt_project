...
COMP_TIME_CUR_BAL as COMP_TIME_CUR_BAL,
COMP_TIME_YEAR_EARNED as COMP_TIME_YEAR_EARNED,
( CASE WHEN TO_DATE ( PP_END_DATE,
'YYYYMMDD' ) THEN TO_DATE ( PP_END_DATE,
'YYYYMMDD' ) ELSE null END ) as o_PP_END_DATE,
( CASE WHEN TO_DATE ( DAILY_DATE_EARNED,
'YYYYMMDD' ) THEN TO_DATE ( DAILY_DATE_EARNED,
...
2,
'0' ) ) as o_PP_YEAR_NUM
From dsJoiner_exp_ConvertOut as dsJoiner_exp_ConvertOut),
